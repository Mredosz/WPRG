...
//md5 codding string into 32 hexadecimal number
    ...
    $result = Database::query("SELECT * FROM uzytkownik WHERE login = '$login' OR(login ='$login' AND haslo = '$password')");
...
//Add new values into sql
            Database::query("INSERT INTO uzytkownik(login, haslo, id_rola) VALUES ('$login', '$password', '$level')");
